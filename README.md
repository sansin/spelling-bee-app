...
**Current Version:** v2.0 (January 17, 2026)
...
- **Smart Word Masking** - Answer word is masked with underscores in definition display to prevent accidental hints
...
### 🎯 Test Modes (NEW in v2.0)
- **Practice Mode** - AI-prioritized words based on your learning patterns
- **Test Mode** - Complete word list for comprehensive testing
- **Resume Incomplete Tests** - Pick up where you left off with resume modal
- **Session Continuation** - Incomplete tests are kept together with same session ID

### 🔄 Enhanced User Experience (NEW in v2.0)
- **Enter Key Submit** - Press Enter to submit your answer for faster workflow
- **Empty Input Validation** - Warning popup prevents accidental submission of empty answers
- **Modal Close Options** - Close modal with X button or Escape key for better UX
- **Separate Analytics Tabs** - View Practice vs Test analytics separately
...
### 📊 Advanced Analytics (Enhanced in v2.0)
- **Dual Analytics Tabs** - Separate Practice and Test analytics views
...
- **Latest Session Widget** - Quick view of your most recent test performance
- **Complete Test Analytics** - Includes both initial and resumed attempts in same session
...
- **Start Practice** - AI-prioritized words for focused learning
- **Take Test (All Words)** - Complete test with all words for the grade

### 5. Practice/Test
- Click "Listen 🎤" to hear the word pronounced
- Click "🔊 Speak Definition" to learn the word's meaning
  - Definition and usage example display on screen (word is masked)
...
### 6. Resume Incomplete Tests
- If you have an incomplete test, a modal will prompt you to:
  - **Resume Test** - Continue from where you left off
  - **Restart Test** - Start fresh with a new session
  - Close with X button or Escape key

### 7. Review Analytics
- Click "View Analytics" on the home screen
- Toggle between "Practice Analytics" and "Practice Test Analytics" tabs
...
- Latest Practice Test widget shows combined analytics for entire test session
...
| Backend | Node.js/Express | Local server for development |
...
spelling-bee-app/
├── index.html              # Main UI
├── script.js              # Core logic & analytics
...
### v2.0 (January 17, 2026) - Enhanced UX & Analytics
**Major New Features:**
- ✅ Dual test modes: Practice (AI-prioritized) vs Test (all words)
- ✅ Resume incomplete tests with intelligent modal
- ✅ Word masking in definitions to prevent hints
- ✅ Enter key submission for faster workflow
- ✅ Empty input validation with warning popup
- ✅ Modal close options (X button & Escape key)
- ✅ Separate Practice/Test analytics tabs
- ✅ Complete test analytics (initial + resumed)
- ✅ Enhanced Latest Test widget with clarification

See [RELEASE_NOTES_v2.0.md](RELEASE_NOTES_v2.0.md) for detailed changelog.

### v1.1 (January 4, 2026) - Definition Lookup
- ✅ Dynamic word definitions via Free Dictionary API
- ✅ Auto-pronunciation of definitions
...
See [STABLE_VERSION.md](STABLE_VERSION.md) for detailed v1.0 feature list.
...
2. Include error details and browser information
3. Reference the branch: `release/v2.0` or `main`
...
Latest Release: **v2.0** (January 17, 2026)
